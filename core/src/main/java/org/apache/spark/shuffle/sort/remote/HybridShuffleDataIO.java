 ...
 */
public class HybridShuffleDataIO implements ShuffleDataIO {

  private final SparkConf sparkConf;

  public HybridShuffleDataIO(SparkConf sparkConf) {
    this.sparkConf = sparkConf;
  }

  @Override
  public ShuffleExecutorComponents executor() {
    return new HybridShuffleExecutorComponents(sparkConf, new LocalDiskShuffleExecutorComponents(sparkConf));
  }

  @Override
  public ShuffleDriverComponents driver() {
    return new HybridShuffleDriverComponents(new LocalDiskShuffleDriverComponents());
  }
}
